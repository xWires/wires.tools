...
<template>
  <div class="glowing-border-green" id="header-container">
    ...
    <a href="https://github.com/xWires/wires.tools" class="transition duration-150 ease-in-out hover:scale-110" style="margin-right: 15px;"><i class="fa-brands fa-github" style="color: white; font-size: 40px;"></i></a>
  </div>
</template>